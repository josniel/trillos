  ...
  <div class="q-pa-md">
    ...
    <div class="row items-center">
      ...
      <div class="q-ml-md q-mt-lg row">
        <q-file label="Click aqui" hint="Obligatorio" dense class="q-pa-sm" bg-color="yellow-2" style="width:200px" v-model="file" accept=".jpg, image/*" @input="changeFile" :error="$v.file.$error" error-message="Este campo es requerido"  @blur="$v.file.$touch()" >
